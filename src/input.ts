...
export const 元素反応バフARRAY = [
    ...
    '月開花反応ダメージ向上',
    '月結晶反応ボーナス',           // for コロンビーナ
    '月結晶反応基礎ダメージアップ', // for コロンビーナ
    '月結晶反応ダメージ向上',
    '星電導反応ボーナス',           // for サンドローネ
    '星電導反応基礎ダメージアップ', // for サンドローネ
    '星電導反応ダメージ向上',       // for サンドローネ
    '星拡散反応ボーナス',           // for オデット
    '星拡散反応基礎ダメージアップ', // for オデット
    '星拡散反応ダメージ向上',       // for オデット
];
...
export const 元素反応TEMPLATE = {
    ...
    超激化反応ダメージ: 0,
    草激化反応ダメージ: 0,
    燃焼反応ダメージ会心率: 0,          // for ナヒーダ
    燃焼反応ダメージ会心ダメージ: 0,    // for ナヒーダ
    開花反応ダメージ会心率: 0,          // for ナヒーダ
    開花反応ダメージ会心ダメージ: 0,    // for ナヒーダ
    烈開花反応ダメージ会心率: 0,        // for ナヒーダ
    烈開花反応ダメージ会心ダメージ: 0,  // for ナヒーダ
    超開花反応ダメージ会心率: 0,        // for ナヒーダ
    超開花反応ダメージ会心ダメージ: 0,  // for ナヒーダ
    拡散反応ダメージ会心率: 0,          // for 夢見月瑞希
    拡散反応ダメージ会心ダメージ: 0,    // for 夢見月瑞希
    月感電反応ダメージ: 0,              // for イネファ
    月感電反応ダメージ会心率: 0,        // for イネファ
    月感電反応ダメージ会心ダメージ: 0,  // for イネファ
    月感電反応ダメージALL: [] as TDamageResultEntry[],  // for イネファ
    月結晶反応ダメージ: 0,              // for コロンビーナ
    月結晶反応ダメージ会心率: 0,        // for コロンビーナ
    月結晶反応ダメージ会心ダメージ: 0,  // for コロンビーナ
    月結晶反応ダメージALL: [] as TDamageResultEntry[],  // for コロンビーナ
    星電導反応ダメージ: 0,              // for サンドローネ
