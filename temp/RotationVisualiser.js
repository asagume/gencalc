                ...
                actionGroupObj['actionList'].forEach(actionObj => {
                    ...
                    switch (actionObj['action']) {
                        ...
                        case 'C':   // 重撃
                            frames = null;
                            if (rotationMaster) {
                                let myType = actionObj['type'] ? actionObj['type'] : '重撃';
                                if (myType in rotationMaster['通常攻撃']['Frames']) {
                                    frames = rotationMaster['通常攻撃']['Frames'][myType];
                                }
                            }
                        ...
                        case 'E':   // 元素スキル
                            frames = null;
                            if (rotationMaster) {
                                let myType = actionObj['type'] ? actionObj['type'] : '一回押し';
                                if (myType in rotationMaster['元素スキル']['Frames']) {
                                    frames = rotationMaster['元素スキル']['Frames'][myType];
                                }
                            }
                            actionObj['time'] = getTimeNumber(frames, 60);
                            break;
