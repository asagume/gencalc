async function onLoad(searchParams) {
    ...
    Pane4Group.set(WeaponSelectVm);
    Pane4Group.set(ArtifacSetSelectVm);
    Pane4Group.set(ArtifactDetailInputVm);
}
        ...
        watch: {
            name: {
                handler: function (newVal, oldVal) {
                    updateStatusInputStatus(calculateStatus(this, StatusInputVm, ArtifactDetailInput));
                },
                deep: true
            },
            突破レベル: {
