    ...
    const OptionInput = {
        data() {
            return {
                ...
                元素共鳴: {},
                元素共鳴詳細: {},
                teamOptionConditionMap: new Map(),
                supporterList: [],
        ...
        created() {
            ...
            this.teamOptionConditionMap.forEach((teamOptionCondition, supporter) => {
                if (!(supporter in this.teamOptionConditions)) {
                    this.teamOptionConditions[supporter] = {};
                }
                teamOptionCondition.forEach((value, key) => {
                    if (value) {
                        this.teamOptionConditions[supporter][key] = null;
                    } else {
                        this.teamOptionConditions[supporter][key] = false;
                    }
                });
            });
        ...
        methods: {
            ...
            supporterInputList: function (supporter) {
                const result = [];
                this.teamOptionConditionMap.get(supporter).forEach((value, key) => {
