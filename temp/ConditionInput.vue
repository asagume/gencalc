...
<script lang="ts">
import { calculateFormulaArray, checkConditionMatches, makeValidConditionValueArr, ALL_ELEMENTS } from "@/calculate";
import { deepcopy } from "@/common";
import { DAMAGE_RESULT_TEMPLATE, STAT_PERCENT_LIST, TCharacterInput, TConditionInput, TStats } from "@/input";
