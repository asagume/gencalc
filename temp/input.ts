...
export function makeFormulaTemplate(
    ...
    if (formula === undefined || formula === null) {
        ...
        const symbols = "!\"$&'()*+,-/:;<=>?@[\\]^_`{|}~";   //  と#と%と.を除いた半角記号
