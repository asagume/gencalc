<template>
  <div class="base-container">
    ...
    <div class="pane4">
      ...
      <ArtifactScoreFormula ref="ArtifactScoreFormulaVmRef" @apply:formula="applyArtifactScoreFormula" v-if="false" />
    </div>
  ...
  setup(props) {
    ...
    const updateRecommendation = async (recommendation: TRecommendation) => {
      ...
      if ('artifactScoring' in recommendation.build) {
        artifactScoringStats.splice(0, artifactScoringStats.length, ...recommendation.build.artifactScoring);
