<template>
  <div class="base-container">
      ...
      <div v-if="pane6Toggle2Ref" style="margin-bottom: 10px">
        ...
        <div>
          <NextStat :visible="true" :characterInput="characterInputRea" :artifactDetailInput="artifactDetailInputRea"
            ...
            :damageResult="damageResult" :rotationDamageArr="rotationDamageArr"
    ...
    <div class="pane5">
      <RotationDamage :characterMaster="characterInputRea.characterMaster" :damageResult="damageResult" @update:rotation-damage="updateRotationDamage"  />
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const rotationDamageArr = reactive([] as TRotationDamageEntry[]);
    ...
    const updateRotationDamage = (argRotationDamageArr: TRotationDamageEntry[]) => {
      rotationDamageArr.splice(0, rotationDamageArr.length, ...argRotationDamageArr);
    };
