...
import { ELEMENTAL_RESONANCE_MASTER, ELEMENTAL_RESONANCE_MASTER_LIST, ELEMENT_COLOR_CLASS, TElementalResonanceKey } from "@/master";
  ...
  setup(props, context) {
    ...
    const descriptionList = computed(() => {
      ...
      for (const name of Object.keys(elementalResonanceCheckedRea).filter(
        ...
        result.push([name, ELEMENTAL_RESONANCE_MASTER[name as TElementalResonanceKey].説明]);
      }
      return result;
    })
