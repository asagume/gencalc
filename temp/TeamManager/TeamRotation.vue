  ...
  <div class="team-rotation">
    <fieldset class="icon-list">
      <template v-for="member in team.members" :key="member.id">
        <div class="with-tooltip" v-if="getElementalSkillDetail(member)">
          ...
          <span class="tooltip">
            ...
            {{ displayName(getElementalSkillDetail(member).名前) }}
          </span>
        </div>
        <div class="with-tooltip" v-if="getElementalBurstDetail(member)">
          ...
          <span class="tooltip">
            {{ displayName(member.name) }}
            {{ displayName(getElementalBurstDetail(member).名前) }}
          </span>
        </div>
      </template>
    </fieldset>
        ...
        <template #item="{ element, index }">
          <div v-if="actionDetail(element)" :class="'rotation-item'+colorClass(element.member)">
            ...
            <div class="with-tooltip">
              ...
              <span class="tooltip"> {{ displayName(element.member) }} </span>
            </div>
            <div class="with-tooltip">
              ...
              <span class="tooltip"> {{ displayName(actionDetail(element).名前) }} </span>
            </div>
