        ...
        <div class="message-area">
            <fieldset>
                ...
                <div v-show="isShowUsage" style="text-align: left;">
                    <div style="text-align: center;">{{ displayName('はじめに') }}</div>
                    <ol>
                        <li>元素チャージ効率が変動するタイプの天賦や命ノ星座は無視します。 </li>
                        <li>HP等ステータスの値を条件にして発動するタイプの天賦や命ノ星座は無視するか、最小の発動回数で計算します。</li>
                        <li>敵の数は1。</li>
                    ...
                    <div style="text-align: center;">{{ displayName('ローテーションの扱いについて') }}</div>
                    <ol>
                        <li>ローテーションの長さ<br>
                            ローテーションに存在する元素スキルのクールタイムまたは元素爆発のクールタイムから決定します。
                            元素スキルの発動回数は考慮しませんが、元素爆発の発動回数に応じて加算します。
                            初期値は20秒。
                        </li>
