  ...
  setup(props, context) {
    ...
    const teamTagOnClick = (tag: string) => {
      if (teamTagSelected(tag)) {
        workTeam.tags = workTeam.tags.splice(0, workTeam.tags.length, ...workTeam.tags.filter(s => s != tag));
      } else {
