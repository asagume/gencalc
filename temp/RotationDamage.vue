...
import { getDamageResultArr, TRotationDamageEntry, REACTION_DMG_ARR, REACTION_DMG_ELEMENT_MAP, calculateRotationTotalDamage } from "@/calculate";
import {
  TDamageResult,
...
export default defineComponent({
  ...
  setup(props, context) {
    ...
    watch(rotationDamageCustomList, () => {
      context.emit('update:rotation-damage', rotationDamageList.value);
    });
